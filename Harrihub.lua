...
function Script()
    local Window = Library.CreateLib("HarriHub", "Synapse")



    local Main = Window:NewTab("Main")
    local MainSection = Main:NewSection("All scripts created by Harrison")
    ...
    CreditsSection:NewLabel("Created by Harrisons")
